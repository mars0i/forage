...
(defn toroidal-to-vega-lite
  ...
  sequence of connected lines need to share a label that is different
  from other sequences of connected lines; this is what allows distinct,
  disconnected sequences connected lines.  base-label is a string that
  will be the initial part of each label (which can appear in a legend)."
  [base-label pts]
