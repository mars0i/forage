...
(defn composite-brownian-vecs
  ...
  generate the next vector.  Each tran rule will be interpreted as
  returning either a truthy or falsey value.  tran rules will be passed
  the entire subsequence so far that has been generated using the
  current step vector function."
