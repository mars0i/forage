...
(defn levy-vecs
  "Returns an infinite sequence of vectors generated by step-vector-rn
  representing a Lévy walk with direction distribution dir-dist, and
  length distribution len-dist, minimum value low and maximum value high."
  [dir-dist len-dist low high]
