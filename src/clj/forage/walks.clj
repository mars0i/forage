...
(defn composite-brownian-vecs
  ...
  tran-rules is a sequence of functions that determine whether to shift,
  ...
  [step-vec-fns tran-rules]
  (if (not= (count step-vec-fns) (count tran-rules))
    (println "composite-brownian-vecs failed:" 
             (count step-vec-fns) "step-vec-fns and"
             (count tran-rules) "tran-rules")
