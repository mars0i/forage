...
(comment
  ...
  (def found-coords (:found-coords data-rng-ssymm))
  ...
  (oz/view! (make-heatmap 800 0 (* 2 half-size) 10000 cmap1001))
  (oz/view! (make-heatmap 800 0 (* 2 half-size) 10000 cmap20))
  (oz/view! (make-heatmap 800 800000  1200000   10000 cmap20))
  (oz/view! (make-heatmap 800 0 (* 2 half-size) 10000 cmap30))

  (oz/view! (make-heatmap 800 0 (int (cm/sqrt (* 2 half-size))) 30 cmap1001linear))

  (oz/view! (make-heatmap 800 600000 1400000 5000 cmap20))

  (oz/view! (make-heatmap 800 990000 1010000 500 cmap30))
