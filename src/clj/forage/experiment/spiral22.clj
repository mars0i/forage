...
(def mu1xdist (r/make-powerlaw rng 1 1.1))
...
(comment
  ...
  (time (oz/view! (h/vega-envwalk-plot (envs 3) 600 0.7 1000 walk1s)))

  (def walk13 (time (w/walk-stops [half-size half-size] (composite-mu1-mu3-vecs (params :maxpathlen)))))
  (def vwalk13 (time (h/vega-envwalk-plot (envs 3) 600 1.0 1000 walk13)))  ; 8 minutes
